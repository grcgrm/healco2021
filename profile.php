...
<?php }?>
    ...
    <?php }?>
                        ...
                        <form class="border shadow rounded-20 text-center bg-info text-white" style="height: 270px; width: 400px; margin-top:-620px; margin-bottom: 50px; margin-left: 940px ;" method="POST" action="" enctype="multipart/form-data" id="manage-doctor">
    ...
    <h5 style="margin-top: 50px;">Active Appointment</h5>
        ...
        <form class="border shadow rounded-20 text-center bg-success text-white" style="height: 270px; width: 400px; margin-top:40px; margin-bottom: 18px; margin-left: 940px ;" method="POST" action="" enctype="multipart/form-data" id="manage-doctor">
