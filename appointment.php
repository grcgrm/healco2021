        ...
        $row=mysqli_fetch_assoc($res); ?>
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; background-color: #f0f8ff;">
                      ...
                      <option value="2" <?php echo isset($row['status']) && $row['status'] == 2 ? "selected" : '' ; ?>>Completed</option>
...
<?php 
         if(empty($row['image']))
         {
           echo '<img src="uploads/default.png" alt="" width="180px" height="180px" style="margin-top: 20px; border-radius:100px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">';
         } else{ ?>
          
          <img src="uploads/<?php echo $row['image']?>" width="180px" height="180px" style="margin-top: 20px; border-radius:100px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"/>
